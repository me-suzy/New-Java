 ...
 * Utilitati.java
 *
 * Created on August 26, 2004, 10:11 AM
 */
...
public class Utilitati {
    public static String user="bebe";
    public static String password="domnita";
    public static String service="10.10.10.5:1521:Bebe";
    ...
    return conexiune;
     ...
     public static void tratareErori(Exception err){
         ...
         //else if (err instanceof StringFormatException)
         //{ javax.swing.JOptionPane.showMessageDialog(null,
